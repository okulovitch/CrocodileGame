...
import com.okul.crocodile.data.remote.ws.models.DrawAction
import com.okul.crocodile.util.Constants.TYPE_ANNOUNCEMENT
import com.okul.crocodile.util.Constants.TYPE_CHAT_MESSAGE
import com.okul.crocodile.util.Constants.TYPE_CHOSEN_WORD
import com.okul.crocodile.util.Constants.TYPE_CUR_ROUND_DRAW_INFO
import com.okul.crocodile.util.Constants.TYPE_DISCONNECT_REQUEST
import com.okul.crocodile.util.Constants.TYPE_DRAW_ACTION
import com.okul.crocodile.util.Constants.TYPE_DRAW_DATA
import com.okul.crocodile.util.Constants.TYPE_GAME_ERROR
import com.okul.crocodile.util.Constants.TYPE_GAME_STATE
import com.okul.crocodile.util.Constants.TYPE_JOIN_ROOM_HANDSHAKE
import com.okul.crocodile.util.Constants.TYPE_NEW_WORDS
import com.okul.crocodile.util.Constants.TYPE_PHASE_CHANGE
import com.okul.crocodile.util.Constants.TYPE_PING
...
class CustomGsonMessageAdapter<T> private constructor(
    ...
    override fun fromMessage(message: Message): T {
        val stringValue = when (message) {
            ...
            is Message.Bytes -> message.value.toString()//never send from backend
        }
    ...
    //crash if pass no base model as param
